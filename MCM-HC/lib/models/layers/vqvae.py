...
class VectorQuantizer(nn.Module):
    ...
    def forward(self, latents: Tensor) -> Tensor:
        ...
        flat_latents = latents.contiguous().view(-1, self.D)  # [BHW x D]
        ...
        return quantized_latents.contiguous(), encoding_inds, vq_loss  # [B x D x H x W]
