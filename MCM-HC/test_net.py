...
def main():
    ...
    output_dir = os.path.join(os.path.dirname(args.checkpoint_file))
    ...
    data_loaders_val = make_data_loader(cfg, is_train=False, is_val=False)
    for output_folder, dataset_name, data_loader_val in zip(
        ...
        inference(
            ...
            sum_sim=cfg.TEST.SUM_SIM,
            rerank=False,
            # coco_1k=cfg.TEST.COCO_1K
        )
        synchronize()
